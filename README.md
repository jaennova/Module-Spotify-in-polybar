# Simple script to show the playback status of the Spotify streaming platform

#### can also be used for any other player, as well as view the playback status of the current browser
